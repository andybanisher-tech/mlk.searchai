...
class Stats
{
    ...
    public static function getSuggestions(string $query): array
    {
        ...
        // Множество слов запроса в нижнем регистре для фильтрации
        ...
        // Фильтрация: убираем подсказки, которые уже есть в запросе, или совпадают с последним словом, или короче 3 символов
